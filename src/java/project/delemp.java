    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
  	    ...
  	    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/hostel","root","123");
            ...
            ResultSet rs=stmt.executeQuery("select * from employee where name='"+name+"' and id='"+id+"'");
            if(rs.next())
            {int q=stmt.executeUpdate("delete from employee where id='"+id+"'");
            ...
            {out.print("<br><br><br><br><hr size='8'><center><font size=6 face='book antiqua'>"
                + "<i>Invalid Id/Name!</i></font><hr size='8'></center>");return;
            }
